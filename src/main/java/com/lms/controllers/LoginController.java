 ...
 * 
 * @author oumnia/souad/oumaima/brahim
 *
 */
@Controller
...
@Autowired
    ...
    public ModelAndView registration(ModelAndView mav) {
        ...
        mav.addObject("ServiceList",serviceManageService.getAllActiveServices());
        mav.addObject("userInfo", employee);
    ...
    public ModelAndView createNewUser(ModelAndView mav, @Valid Employee employee, BindingResult bindResult) {
        ...
        Role role = roleManageService.getRoleById(employee.getRole().getId());
        employee.setRole(role);

        employee.setDate_naissance("19/04/1997");
