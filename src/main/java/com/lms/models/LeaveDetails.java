...
public class LeaveDetails implements Serializable {
    ...
    @Column(name = "employee_id_manager")
    ...
    public int getEmployee_id_manager() {
        return employee_id_manager;
    }

    public void setEmployee_id_manager(int employee_id_manager) {
    ...
    public LeaveDetails(String username, String employeeName, String nomTache, Date fromDate, Date toDate, String leaveType, String reason, int duration, boolean acceptRejectFlag, String completed, boolean active, Projet projet, Set<Commentaire> commentaires) {
        this.username = username;
        this.employeeName = employeeName;
        this.nomTache = nomTache;
        this.fromDate = fromDate;
